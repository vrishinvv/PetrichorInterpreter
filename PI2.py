        ...
        text = """\
                BEGIN
                    ...
                    BEGIN
                        number := 2;
                        a := --1;
                        IF (a<1) BEGIN hello:=5 END
                        ELSEIF (a<2) BEGIN hello:=6 END
                        ELSEIF (a<3) BEGIN hello:=7 END
                        ELSEIF (a<4) BEGIN hello:=8 END
                        ELSEIF (a<5) BEGIN hello:=9 END
                        ELSEIF (a<6) BEGIN hello:=10 END
                        ELSEIF (a<7) BEGIN hello:=11 END
                        ELSE BEGIN hello:=12 END
                        FI;
